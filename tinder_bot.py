...
class TinderBot(object):
    def __init__(self):
        self.driver = webdriver.Chrome('C:/Users/icaro/Documents/chromed/chromedriver1.exe')

    def login(self):
        username = 'icarobicalho@hotmail.com'
        password = 'password'
        self.driver.get('https://tinder.com')

        sleep(3)

        aceito_btn = self.driver.find_element_by_xpath('//*[@id="content"]/div/div[2]/div/div/div[1]/button')
        aceito_btn.click()
        ...
        sleep(8)
        popup_3 = self.driver.find_element_by_xpath('//*[@id="content"]/div/div[1]/div/div/main/div/div[1]/div/div[2]/div[4]/button')
        popup_3.click(7)
